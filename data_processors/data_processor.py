                ...
                for r2gen_id, r2gen_value in sample.items():
                    ...
                    if uid in kaggle_uids_mesh_impression:
                        ...
                        if r2gen_value["report"] == kaggle_report:
                            ...
                            r2gen_value["report"] = self.tokenizer.clean_report(r2gen_value["report"])
                            autogenerated_ontology_report = self.negation.generate_annotation_with_negation(
                                r2gen_value["report"], r2gen_id, "report", True if iu_mesh == "normal" else False)
                            r2gen_value.update({
                                "iu_mesh": iu_mesh, "mesh": mesh_text, "attr": attr_text,
                                "mesh_attr": mesh_attr_text,
                                "impression": self.tokenizer.clean_report(
                                    kaggle_uids_mesh_impression[uid]["impression"]),
                                "auto_generated_ontology_report": autogenerated_ontology_report,
                                "auto_generated_ontology_impression": self.negation.generate_annotation_with_negation(
                                    self.tokenizer.clean_report(kaggle_uids_mesh_impression[uid]["impression"]),
                                    r2gen_id, "impression", True if iu_mesh == "normal" else False)})
                            matched_split[split][r2gen_id] = r2gen_value
                            matched[r2gen_id] = r2gen_value
                        else:
                            unmatched_split[split][r2gen_id] = {"r2gen_uid": uid, "r2gen_report": r2gen_value["report"],
                                                                "kaggle_report": kaggle_report}
                            unmatched[r2gen_id] = {"r2gen_uid": uid, "r2gen_report": r2gen_value["report"],
                                                   "kaggle_report": kaggle_report}
                    else:
                        unmatched_split[split][r2gen_id] = {"r2gen_uid": uid, "r2gen_report": r2gen_value["report"],
                                                            "kaggle_report": ""}
